...
SELECT first_name, last_name, address, address2, district, city_id, postal_code FROM staff
...
SELECT title, COUNT(rental.inventory_id) AS 'Times_Rented' FROM rental
...
SELECT store_id, SUM(amount) AS Total_Sales FROM payment
...
SELECT name AS 'Genre', SUM(amount) AS 'Total_Revenue' from category
